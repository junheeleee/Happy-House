...
public class QnA {
	...
	public String toString() {
		return "QnA [qnaNo=" + qnaNo + ", qnaTitle=" + qnaTitle + ", qnaContent=" + qnaContent + ", qnaUserid="
				...
				+ replyDatetime + ", replyUserid=" + replyUserid + ", getQnaNo()=" + getQnaNo() + ", getQnaTitle()="
				+ getQnaTitle() + ", getQnaContent()=" + getQnaContent() + ", getQnaUserid()=" + getQnaUserid()
				+ ", getQnaDatetime()=" + getQnaDatetime() + ", getReplyContent()=" + getReplyContent()
				+ ", getReplyDatetime()=" + getReplyDatetime() + ", getReplyUserid()=" + getReplyUserid()
